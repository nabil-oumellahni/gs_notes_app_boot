		...
		<f:form action="${pageContext.request.contextPath}/admin/updatePerson"
			...
			<div class="row">
				<div class="col">
					...
					<f:input path="cin" type="text" class="form-control"
						placeholder="cin" value="${personModel.cin}"/>
				...
				<div class="col">
					...
					<f:input path="nom" type="text" class="form-control"
						placeholder="nom" value="${personModel.nom}"/>
			...
			<div class="row">
				<div class="col">
					...
					<f:input path="prenom" type="text" class="form-control"
						placeholder="prenom" />
					<f:errors path="prenom" class="text-danger" value="${personModel.prenom}"/>
				</div>
				...
				<div class="col">
					...
					<f:errors path="telephone" class="text-danger" value="${personModel.telephone}"/>
				</div>
			</div>
			...
			<div class="row">
				<div class="col">
					...
					<f:errors path="email" class="text-danger" value="${personModel.email}"/>
				</div>
				<c:if test="${personModel.typePerson == 1}" var="variable">
					<div class="col">
